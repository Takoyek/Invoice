...
def process_text(line):
    ...
    mappings = [
        (r"صد.?و?.?پنجاه (گیگ|گیک|کیگ|گبگ|کیک)", "✅  [195]"),
        (r"صد.?و?.?بیست (گیگ|گیک|کیگ|گبگ|کیک).*?(صد.?و?.?بیست روز)", "✅  [180]"),
        (r"صد.?و?.?بیست (گیگ|گیک|کیگ|گبگ|کیک).*?نود روز", "✅  [165]"),
        (r"صد.?و?.?بیست (گیگ|گیک|کیگ|گبگ|کیک)", "✅  [156]"),
        (r"\bصد (گیگ|گیک|کیگ|گبگ|کیک)\b.*?نود روز", "✅  [150]"),
        (r"\bصد (گیگ|گیک|کیگ|گبگ|کیک)\b", "✅  [170]"),
        (r"نود (گیگ|گیک|کیگ|گبگ|کیک).*?نود روز", "✅  [135]"),
        (r"نود (گیگ|گیک|کیگ|گبگ|کیک).*?(شصت روز|شصد روز)", "✅  [120]"),
        (r"نود (گیگ|گیک|کیگ|گبگ|کیک)", "✅  [117]"),
        (r"هشتاد (گیگ|گیک|کیگ|گبگ|کیک)(?!.*صد.?و?.?هشتاد (گیگ|گیک|کیگ|گبگ|کیک)).*?(شصت روز|شصد روز)", "✅  [110]"),
        (r"هشتاد (گیگ|گیک|کیگ|گبگ|کیک)(?!.*صد.?و?.?هشتاد (گیگ|گیک|کیگ|گبگ|کیک))", "✅  [104]"),
        (r"هفتاد (گیگ|گیک|کیگ|گبگ|کیک)", "✅  [91]"),
        (r"(شصت|شصد) (گیگ|گیک|کیگ|گبگ|کیک)(?!.*صد.?و?.?شصت (گیگ|گیک|کیگ|گبگ|کیک)).*?نود روز", "✅  [105]"),
        (r"(شصت|شصد) (گیگ|گیک|کیگ|گبگ|کیک)(?!.*صد.?و?.?شصت (گیگ|گیک|کیگ|گبگ|کیک)).*?(شصت روز|شصد روز)", "✅  [90]"),
        (r"(شصت|شصد) (گیگ|گیک|کیگ|گبگ|کیک)(?!.*صد.?و?.?شصت (گیگ|گیک|کیگ|گبگ|کیک))", "✅  [78]"),
        (r"پنجاه (گیگ|گیک|کیگ|گبگ|کیک)(?!.*صد.?و?.?پنجاه (گیگ|گیک|کیگ|گبگ|کیک))", "✅  [85]"),
        (r"چهل (گیگ|گیک|کیگ|گبگ|کیک)(?!.*صد.?و?.?چهل (گیگ|گیک|کیگ|گبگ|کیک)).*?(شصت روز|شصد روز)", "✅  [70]"),
        (r"چهل (گیگ|گیک|کیگ|گبگ|کیک)(?!.*صد.?و?.?چهل (گیگ|گیک|کیگ|گبگ|کیک))", "✅  [55]"),
        (r"سی (گیگ|گیک|کیگ|گبگ|کیک)", "✅  [65]"),
        (r"بیست (گیگ|گیک|کیگ|گبگ|کیک)(?!.*صد.?و?.?بیست (گیگ|گیک|کیگ|گبگ|کیک))", "✅  [35]"),
        (r"ده (گیگ|گیک|کیگ|گبگ|کیک)", "✅  [25]")
    ]
